(function() {
  ...
  Myna.$ = (_ref2 = window.jQuery) != null ? _ref2 : null;
...
(function() {
  Myna.jsonp = {
    ...
    request: function(options) {
      ...
      timeout = (_ref3 = options.timeout) != null ? _ref3 : 10 * 1000;
...
(function() {
  ...
  Path = (function() {
    ...
    function Path(input) {
      ...
      this.quote = __bind(this.quote, this);      if (typeof input === "string") {
...
(function() {
  ...
  Myna.GoogleAnalytics = (function(_super) {
    ...
    function GoogleAnalytics(client) {
      ...
      this.recordView = __bind(this.recordView, this);
      this.listenTo = __bind(this.listenTo, this);
      this.init = __bind(this.init, this);      Myna.log("Myna.GoogleAnalytics.constructor", client);
      this.client = client;
    }
...
(function() {
  ...
  Myna.Binder = (function() {
    function Binder(client) {
      ...
      this.bindRedirect = __bind(this.bindRedirect, this);
      ...
      this.listenTo = __bind(this.listenTo, this);
      this.init = __bind(this.init, this);      Myna.log("Myna.Binder.constructor", client);
      this.client = client;
      this.boundHandlers = [];
    }
    ...
    Binder.prototype.bind = function(expt, variant) {
      var allElems, bindElems, cssClass, dataBind, dataGoal, dataHide, dataPrefix, dataRedirect, dataShow, goalElems, hideElems, redirectElems, showElems, _ref, _ref1,
        _this = this;
      ...
      dataRedirect = dataPrefix ? "" + this.dataPrefix + "-redirect" : "redirect";
      ...
      redirectElems = cssClass ? allElems.filter("[data-" + dataRedirect + "]") : Myna.$("[data-" + dataRedirect + "]");
      ...
      redirectElems.each(function(index, elem) {
        return _this.bindRedirect(expt, variant, dataRedirect, elem);
      });
    ...
    Binder.prototype.bindRedirect = function(expt, variant, dataAttr, elem) {
      var attr, dest, self;
      ...
      dest = (function() {
        switch (attr) {
          ...
          case "name":
            return variant.name;
          default:
            return variant.settings.get(attr, false);
        }
      })();
      if (dest) {
